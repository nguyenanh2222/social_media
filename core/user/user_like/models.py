...
from core.user.user_comment.models import UserCommentModel
...
class UserLikeModel(models.Model):
    ...
    commentId = models.ForeignKey(UserCommentModel, db_column='commentId', on_delete=models.CASCADE, blank=False)
